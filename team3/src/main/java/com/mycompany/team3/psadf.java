 ...
 * @author hp
 */
public class psadf extends javax.swing.JFrame {

    /**
     * Creates new form psadf
     */
    public psadf() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(psadf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
